        ...
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-[80vh]">
          ...
          <div className="lg:w-1/2 space-y-8 text-center lg:text-left">
            ...
            <p className="text-xl lg:text-2xl text-white/80 leading-relaxed max-w-2xl">
              CLIC reimagines online dating with live virtual events and spontaneous video chats. 
              Experience the magic of real connections, just like meeting someone at a party.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-2 border-white/30 text-white hover:bg-white/10 px-8 py-6 text-lg font-semibold rounded-full backdrop-blur-sm transition-all duration-300 hover:scale-105"
              >
                Learn More
              </Button>
            </div>
                  ...
                  <div className="relative space-y-4">
                    <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-2xl p-4 backdrop-blur-sm">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className="text-white text-sm">Live Event: Coffee Chat</span>
                      </div>
